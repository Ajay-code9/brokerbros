...
export const YieldPricingSection: React.FC<YieldPricingSectionProps> = ({ onOpenAccount }) => {
  return (
    <section id="pricing" className="py-16 sm:py-20 bg-slate-50/80 dark:bg-[#0E1420] border-b border-slate-200 dark:border-[#1E293B] font-sans select-none transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* 3 Clean Enterprise Solution Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">

          {/* Card 1: White-Label CRM */}
          <div className="bg-white dark:bg-[#141C2B] p-6 sm:p-8 border border-slate-200 dark:border-[#1E293B] shadow-xs flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <div className="w-10 h-10 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30 flex items-center justify-center">
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
              <span className="text-xs text-slate-500 dark:text-slate-400 font-medium block">
                Guarantee: <strong className="text-slate-900 dark:text-white font-semibold">Zero User Capacity Caps</strong>
              </span>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-[#141C2B] p-6 sm:p-8 border border-slate-200 dark:border-[#1E293B] shadow-xs flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="pt-2 space-y-2 border-t border-slate-100 dark:border-[#1E293B]">
                <div className="flex items-center gap-2 text-xs text-slate-800 dark:text-slate-200 font-medium">
                  <Check className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400 shrink-0" />
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-[#1E293B]">
              <span className="text-xs text-slate-500 dark:text-slate-400 font-medium block">
                Guarantee: <strong className="text-slate-900 dark:text-white font-semibold">Sub-3ms Execution Latency</strong>
              </span>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-[#141C2B] p-6 sm:p-8 border border-slate-200 dark:border-[#1E293B] shadow-xs flex flex-col justify-between space-y-6">
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
              <span className="text-xs text-slate-500 dark:text-slate-400 font-medium block">
                Guarantee: <strong className="text-slate-900 dark:text-white font-semibold">Real-Time Risk Monitoring</strong>
              </span>
            </div>
          </div>
