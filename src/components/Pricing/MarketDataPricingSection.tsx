    ...
    <section className="py-20 sm:py-24 bg-white dark:bg-[#090D14] border-b border-slate-200 dark:border-[#1E293B] font-sans transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="flex justify-center">
          <div className="bg-slate-100 dark:bg-[#141C2B] p-1 rounded-xl border border-slate-200 dark:border-[#1E293B] inline-flex">
            <button
              onClick={() => setUserType('non-pro')}
              className={`px-5 py-2.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                userType === 'non-pro'
                  ? 'bg-white dark:bg-emerald-500 text-emerald-700 dark:text-slate-950 shadow-xs border border-slate-200 dark:border-emerald-500'
        ...
        <div className="bg-slate-50/80 dark:bg-[#0E1420] rounded-2xl border border-slate-200/90 dark:border-[#1E293B] p-6 sm:p-8 space-y-8">
          
          {/* Top Callout Box */}
          <div className="bg-emerald-50 dark:bg-emerald-500/10 p-5 rounded-xl border border-emerald-200 dark:border-emerald-500/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs">
            ...
            <span className="bg-emerald-600 dark:bg-emerald-500 text-white dark:text-slate-950 font-mono font-bold px-3 py-1 rounded-lg uppercase tracking-wider shrink-0 text-center text-[11px]">
              $0.00 / Mo Fee Waiver
            </span>
          </div>

          {/* Exchange Table */}
          <div className="overflow-x-auto bg-white dark:bg-[#141C2B] rounded-xl border border-slate-200 dark:border-[#1E293B] shadow-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-[#141C2B] p-5 rounded-xl border border-slate-200/90 dark:border-[#1E293B] space-y-2">
