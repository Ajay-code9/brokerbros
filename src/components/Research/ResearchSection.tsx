...
export const ResearchSection: React.FC<ResearchSectionProps> = ({ onOpenAccount }) => {
  return (
    <section id="research" className="py-16 lg:py-20 bg-slate-50/70 text-slate-900 border-b border-slate-200 font-sans relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
        
        {/* Humanized B2B Operator Guides Header */}
        <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-end border-b border-slate-200 pb-8">
          
          {/* LEFT SIDE: Clean Header & Feature Pills */}
          <div className="lg:col-span-8 space-y-4 text-left relative z-10">
            
            {/* Clean Simple Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-emerald-50 text-emerald-800 font-mono text-[11px] font-bold border border-emerald-200 shadow-2xs">
              <BookOpen className="w-3.5 h-3.5 text-emerald-600" />
              <span>RESOURCES & SETUP GUIDES</span>
            </div>

            {/* Natural Human Heading */}
            <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-bold tracking-tight text-slate-900 font-sans leading-[1.15]">
              Brokerage Launch Guides <span className="text-emerald-600">&</span> Documentation
            </h2>
            ...
            <div className="pt-2 flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-6 border-t border-slate-200/80 pt-4">
              
              {/* Feature 1 */}
              <div className="flex items-center gap-3 pr-4 sm:pr-6 border-r border-slate-200 shrink-0">
                ...
                <div>
                  <div className="text-base font-bold text-slate-900 font-mono leading-none">14</div>
                  <div className="text-[11px] font-medium text-slate-500 mt-1">Platform Modules</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 pr-4 sm:pr-6 border-r border-slate-200 shrink-0">
                ...
                <div>
                  <div className="text-base font-bold text-slate-900 font-mono leading-none">FIX 4.4</div>
                  <div className="text-[11px] font-medium text-slate-500 mt-1">API Documentation</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <div>
                  <div className="text-base font-bold text-emerald-700 font-mono leading-none">48 Hours</div>
                  <div className="text-[11px] font-medium text-slate-500 mt-1">Avg Onboarding Time</div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {RESEARCH_ARTICLES.map((article) => (
            <article
              key={article.id}
              className="bg-white rounded-2xl border border-slate-200/90 p-6 flex flex-col justify-between hover:border-emerald-500/70 hover:shadow-md transition-all group"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between text-xs font-mono">
                  <span className="px-2.5 py-1 bg-emerald-50 text-emerald-800 font-bold rounded border border-emerald-200">
                    {article.tag}
                  </span>
        ...
        <div className="bg-slate-900 text-white rounded-2xl border border-slate-800 p-6 sm:p-8 font-sans shadow-lg">
