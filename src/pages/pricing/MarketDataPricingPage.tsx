  ...
  return (
    <div className="bg-white text-slate-900 font-sans antialiased selection:bg-emerald-500 selection:text-white">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/backgroundpricefourth.png')" }}
      >
        <div className="absolute top-0 right-1/3 w-[500px] h-[500px] bg-emerald-50/60 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6 w-full">
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-950 tracking-tight leading-[1.12]">
              ...
              <span className="text-emerald-600">WebSocket / FIX Data Pricing</span>
            </h1>
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 pb-8 pt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto border-t border-slate-100 pt-6 text-center">
            <div>
              <div className="text-2xl sm:text-3xl font-black text-slate-950 font-mono">$0 / mo Waiver</div>
              <div className="text-xs text-slate-500 font-medium mt-1">Available for Active Traders</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-black text-emerald-600 font-mono">Depth of Market</div>
              <div className="text-xs text-slate-500 font-medium mt-1">Level 2 Book Liquidity</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-black text-slate-950 font-mono">FIX & WebSockets</div>
              <div className="text-xs text-slate-500 font-medium mt-1">Sub-Millisecond Data Stream</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <h3 className="text-2xl font-bold text-slate-900">Tick-By-Tick Data Feeds for Algorithmic & Web Traders</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-2">
              <div className="text-xs font-mono font-bold text-emerald-600 uppercase">Tick-By-Tick Streaming</div>
              <div className="text-lg font-bold text-slate-900">Sub-10ms Price Updates</div>
              <p className="text-xs text-slate-600 leading-relaxed">Zero sample averaging. Get raw exchange order book updates instantly to WebTrader, Mobile Apps, or custom Python SDKs.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-2">
              <div className="text-xs font-mono font-bold text-emerald-600 uppercase">Level 2 Depth of Market</div>
              <div className="text-lg font-bold text-slate-900">Full Book Transparency</div>
              <p className="text-xs text-slate-600 leading-relaxed">View top 10 bid & ask price levels across 150+ liquidity venues to identify large institutional block orders.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-2">
              <div className="text-xs font-mono font-bold text-emerald-600 uppercase">Automatic Fee Waivers</div>
              <div className="text-lg font-bold text-slate-900">100% Rebated for Active Accounts</div>
              <p className="text-xs text-slate-600 leading-relaxed">Generate $30+ in monthly commissions to automatically waive non-professional market data subscription fees.</p>
            </div>
          </div>
        </div>
      </section>
