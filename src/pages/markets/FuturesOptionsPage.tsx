          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-3.5">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-[1.1] text-slate-950 font-sans">
                ...
                <span className="text-emerald-700">& Micro E-Mini Execution</span>
              </h1>
              ...
              <div className="pt-4 border-t border-slate-100 grid grid-cols-3 gap-4 text-xs font-mono">
                <div>
                  ...
                  <div className="text-emerald-700 font-extrabold text-sm sm:text-base mt-0.5">CME, Eurex, ICE</div>
                </div>
                <div>
                  <div className="text-slate-400 text-xs">Fill Latency</div>
                  <div className="text-slate-950 font-extrabold text-sm sm:text-base mt-0.5">&lt; 1.2 ms (Aurora)</div>
                </div>
                <div>
                  <div className="text-slate-400 text-xs">Intraday Margin</div>
                  <div className="text-emerald-700 font-extrabold text-sm sm:text-base mt-0.5">50% Day Leverage</div>
                </div>
              </div>
            </div>
