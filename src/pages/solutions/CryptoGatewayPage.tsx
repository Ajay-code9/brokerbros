...
export const CryptoGatewayPage: React.FC<PageProps> = ({ onOpenAccount }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-300 min-h-screen transition-colors duration-300 selection:bg-emerald-500/30 font-sans">
      ...
      <ProductVideoSection
        title="Automated Crypto Deposit & Settlement Engine"
        subtitle="See how unique wallet generation, instant fiat conversion, and cold/hot storage vaulting streamline client funding."
        videoSrc="/test3.mp4"
      ...
      <ProductGallerySection
        title="Crypto Deposit & Wallet Settlement Gallery"
        subtitle="Explore unique deposit address generation, instant USDT/BTC conversion gateways, and cold storage vault logs."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-200 dark:divide-slate-800/50">
            <div className="text-center">
              <div className="text-3xl font-black text-slate-900 dark:text-white font-mono mb-1">50+</div>
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Blockchains</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Chargebacks</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-24 border-b border-slate-200 dark:border-slate-800/50 bg-slate-50/80 dark:bg-transparent relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Crypto Payment Infrastructure</h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg">Accept crypto deposits globally with automatic conversion, unique wallet generation, and enterprise-grade custody security.</p>
          </div>
      ...
      <section className="py-24 border-b border-slate-200 dark:border-slate-800/50 bg-white dark:bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Gateway Architecture</h2>
              <p className="text-slate-600 dark:text-slate-400 text-lg">Institutional-grade crypto payment infrastructure with multi-chain support, automated AML screening, and cold/hot vault custody.</p>
            </div>
      ...
      <section className="py-24 relative overflow-hidden bg-slate-50/80 dark:bg-transparent">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-4xl sm:text-5xl font-black text-slate-900 dark:text-white mb-6">Scale Your Crypto Payment Infrastructure</h2>
