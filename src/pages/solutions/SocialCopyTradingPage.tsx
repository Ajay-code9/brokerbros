        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-800/50">
            <div className="text-center">
              <div className="text-3xl font-black text-white font-mono mb-1">&lt;1ms</div>
              <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">Copy Latency</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">Fee Deductions</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-24 border-b border-slate-800/50 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Social Trading Ecosystem</h2>
            <p className="text-slate-400 text-lg">Build a thriving community where top traders share strategies and followers replicate their success automatically.</p>
          </div>
      ...
      <section className="py-24 border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Copy Trading Architecture</h2>
              <p className="text-slate-400 text-lg">High-performance infrastructure for real-time trade replication, social engagement, and automated revenue distribution at scale.</p>
            </div>
