...
export const PammMamPage: React.FC<PageProps> = ({ onOpenAccount }) => {
  ...
  const faqs = [
    ...
    { q: 'How many sub-accounts can a single master manage?', a: 'There is no limit. Our allocation engine has been tested with 10,000+ sub-accounts per master with zero performance degradation or sync delays.' },
    { q: 'Does it work with MT4 and MT5?', a: 'Yes. Native PAMM/MAM plugins for both MT4 and MT5, plus server-to-server integration with cTrader, DXtrade, and Match-Trader for multi-platform deployments.' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-800/50">
            <div className="text-center">
              <div className="text-3xl font-black text-white font-mono mb-1">10,000+</div>
              <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">Sub-Accounts</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">Slippage</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-24 border-b border-slate-800/50 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Asset Management Suite</h2>
            <p className="text-slate-400 text-lg">Professional PAMM and MAM tools for money managers to allocate trades across thousands of investor sub-accounts.</p>
          </div>
      ...
      <section className="py-24 border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Fund Architecture</h2>
              <p className="text-slate-400 text-lg">Institutional-grade allocation engine with real-time NAV tracking, automated fee distribution, and comprehensive investor reporting.</p>
            </div>
