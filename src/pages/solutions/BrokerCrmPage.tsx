...
export const BrokerCrmPage: React.FC<PageProps> = ({ onOpenAccount }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#090D14] text-slate-900 dark:text-slate-100 min-h-screen transition-colors duration-300 selection:bg-emerald-500/30 font-sans">
      
      {/* 1. HERO SECTION */}
      <section className="relative pt-16 pb-24 overflow-hidden border-b border-slate-200 dark:border-[#1E293B]">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                ...
                <button className="px-8 py-4 bg-slate-100 dark:bg-[#141C2B] hover:bg-slate-200 dark:hover:bg-[#1B2538] text-slate-900 dark:text-white font-bold rounded-lg border border-slate-300 dark:border-[#1E293B] transition-colors flex items-center justify-center gap-2">
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="relative">
                <img 
                  ...
                  className="w-full h-auto rounded-[18px] shadow-2xl border border-slate-200 dark:border-[#1E293B] relative z-10" 
                />
              </div>
            </div>
      ...
      {/* 2. STATS BAR */}
      <section className="bg-slate-50 dark:bg-[#0E1420] border-b border-slate-200 dark:border-[#1E293B]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-200 dark:divide-[#1E293B]">
            <div className="text-center">
              <div className="text-3xl font-black text-slate-900 dark:text-white font-mono mb-1">500+</div>
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Brokers Powered</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-12 border-b border-slate-200 dark:border-[#1E293B] overflow-hidden w-full bg-white dark:bg-[#090D14]">
        ...
        <div className="w-full relative group overflow-hidden">
          <div className="flex animate-marquee gap-4 w-max px-4">
            {[...integrations, ...integrations].map((integration, i) => (
              <div key={i} className="flex-shrink-0 w-48 bg-slate-50 dark:bg-[#141C2B] border border-slate-200 dark:border-[#1E293B] rounded-lg p-4 flex flex-col items-center justify-center text-center hover:bg-white dark:hover:bg-[#1B2538] transition-colors">
                <div className="w-10 h-10 bg-emerald-50 dark:bg-emerald-500/10 rounded-full mb-3 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-black text-xl border border-emerald-200 dark:border-emerald-500/30">
      ...
      <section className="py-24 border-b border-slate-200 dark:border-[#1E293B] bg-slate-50/80 dark:bg-[#0E1420] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Complete Operations Hub</h2>
            <p className="text-slate-600 dark:text-slate-300 text-lg">Engineered specifically for forex brokers, prop firms, and institutional multi-asset trading operations.</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <div key={i} className="bg-white dark:bg-[#141C2B] border border-slate-200 dark:border-[#1E293B] p-6 rounded-2xl hover:border-emerald-500/50 transition-all group shadow-xs">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-900 px-2 py-1 rounded">
                    {feature.badge}
                  </span>
                </div>
      ...
      {/* 5. DEEP DIVE MODULES */}
      <section className="py-24 border-b border-slate-200 dark:border-[#1E293B] bg-white dark:bg-[#090D14]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Advanced Architecture</h2>
              <p className="text-slate-600 dark:text-slate-300 text-lg">Every tool your staff needs to manage thousands of clients efficiently, without touching a database or writing a line of code.</p>
            </div>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-slate-50 dark:bg-[#141C2B] border border-slate-200 dark:border-[#1E293B] p-4 rounded-xl flex items-start gap-3">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 dark:bg-[#1E293B] border border-slate-200 dark:border-[#1E293B] rounded-2xl overflow-hidden">
            {modules.map((module, i) => (
              <div key={i} className="bg-white dark:bg-[#0E1420] p-8">
                <module.icon className="w-8 h-8 text-emerald-600 dark:text-emerald-400 mb-4" />
      ...
      {/* 6. TESTIMONIALS */}
      <section className="py-24 border-b border-slate-200 dark:border-[#1E293B] bg-slate-50/80 dark:bg-[#0E1420] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white">Trusted by Top Brokers</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((test, i) => (
              <div key={i} className="bg-white dark:bg-[#141C2B] border border-slate-200 dark:border-[#1E293B] p-8 rounded-2xl flex flex-col h-full relative group hover:border-emerald-500/50 transition-colors shadow-xs">
                <div className="flex gap-1 mb-6">
                  {[...Array(test.rating)].map((_, j) => (
                    <div key={j} className="w-4 h-4 bg-emerald-500 rounded-sm" />
                  ))}
                </div>
                <p className="text-slate-700 dark:text-slate-300 mb-8 flex-1 relative z-10 text-sm leading-relaxed">
                  "{test.quote}"
                </p>
                <div>
                  <div className="font-bold text-slate-900 dark:text-white">{test.name}</div>
                  <div className="text-xs text-slate-500 dark:text-slate-400">{test.role}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 border-b border-slate-200 dark:border-[#1E293B] bg-white dark:bg-[#090D14]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            {/* Toggle */}
            <div className="inline-flex items-center p-1 bg-slate-100 dark:bg-[#0E1420] border border-slate-200 dark:border-[#1E293B] rounded-lg">
              <button 
                onClick={() => setActivePlan('monthly')}
                className={`px-6 py-2 rounded-md text-sm font-bold transition-all ${activePlan === 'monthly' ? 'bg-white dark:bg-[#141C2B] text-slate-900 dark:text-white shadow-xs' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}`}
              >
                Monthly
              </button>
              <button 
                onClick={() => setActivePlan('annual')}
                className={`px-6 py-2 rounded-md text-sm font-bold transition-all flex items-center gap-2 ${activePlan === 'annual' ? 'bg-emerald-600 text-white shadow-xs' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}`}
              >
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {plans.map((plan, i) => (
              <div key={i} className={`bg-white dark:bg-[#141C2B] border rounded-2xl p-8 flex flex-col ${plan.highlight ? 'border-emerald-500 shadow-xl relative scale-105 z-10' : 'border-slate-200 dark:border-[#1E293B]'}`}>
                {plan.highlight && (
                ...
                <button className={`w-full py-4 rounded-lg font-bold text-sm transition-colors ${plan.highlight ? 'bg-emerald-600 hover:bg-emerald-500 text-white' : 'bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700'}`}>
                  {plan.cta}
                </button>
              </div>
            ))}
      ...
      {/* 8. FAQs */}
      <section className="py-24 border-b border-slate-200 dark:border-[#1E293B] bg-slate-50/80 dark:bg-[#0E1420]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white dark:bg-[#141C2B] border border-slate-200 dark:border-[#1E293B] rounded-xl overflow-hidden transition-all shadow-xs">
                <button 
                  onClick={() => setActiveFaq(activeFaq === i ? null : i)}
                  className="w-full px-6 py-4 flex items-center justify-between font-bold text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-[#1B2538] transition-colors text-left"
                >
                  <span>{faq.q}</span>
                  <div className={`text-emerald-600 dark:text-emerald-400 transition-transform duration-300 ${activeFaq === i ? 'rotate-180' : ''}`}>
                    <ArrowDown className="w-5 h-5" />
                  </div>
                </button>
                {activeFaq === i && (
                  <div className="px-6 pb-6 text-slate-600 dark:text-slate-300 text-sm leading-relaxed border-t border-slate-100 dark:border-[#1E293B] pt-4">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      {/* 9. FINAL CTA */}
      <CTASection onOpenAccount={onOpenAccount} title="Scale Your Brokerage Operations" subtitle="Deploy a fully branded, secure client portal and management hub tailored to your brokerage. Launch in days, not months." />
