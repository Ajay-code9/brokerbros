...
export const FixApiLiquidityPage: React.FC<PageProps> = ({ onOpenAccount }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-300 min-h-screen transition-colors duration-300 selection:bg-emerald-500/30 font-sans">
      ...
      <ProductVideoSection
        title="FIX API Bridge & Smart Liquidity Routing"
        subtitle="Discover sub-5ms order execution, multi-LP aggregation, and Equinix LD4/NY4 co-located cross-connect architecture."
        videoSrc="/test.mp4"
      ...
      <ProductGallerySection
        title="FIX API Bridge & LP Routing Matrix Gallery"
        subtitle="View sub-5ms order execution logs, multi-LP aggregation Depth of Market, and Equinix co-location monitoring tools."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-200 dark:divide-slate-800/50">
            <div className="text-center">
              <div className="text-3xl font-black text-slate-900 dark:text-white font-mono mb-1">FIX 4.4</div>
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Native</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Routing</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-24 border-b border-slate-200 dark:border-slate-800/50 bg-slate-50/80 dark:bg-transparent relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Liquidity Infrastructure</h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg">Connect directly to Tier-1 liquidity providers with ultra-low latency FIX protocol bridges and intelligent order routing.</p>
          </div>
      ...
      <section className="py-24 border-b border-slate-200 dark:border-slate-800/50 bg-white dark:bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Bridge Architecture</h2>
              <p className="text-slate-600 dark:text-slate-400 text-lg">Enterprise-grade FIX 4.4 bridge with multi-LP aggregation, smart order routing, and co-located infrastructure at major financial data centers.</p>
            </div>
      ...
      <section className="py-24 relative overflow-hidden bg-slate-50/80 dark:bg-transparent">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-4xl sm:text-5xl font-black text-slate-900 dark:text-white mb-6">Scale Your FIX API Infrastructure</h2>
