        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-800/50">
            <div className="text-center">
              <div className="text-3xl font-black text-white font-mono mb-1">100k+</div>
              <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">Msg / Sec</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">CDN Edge</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-24 border-b border-slate-800/50 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Streaming Infrastructure</h2>
            <p className="text-slate-400 text-lg">Deliver real-time market data, order book depth, and account updates to any device with ultra-low latency WebSocket connections.</p>
          </div>
      ...
      <section className="py-24 border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Streaming Architecture</h2>
              <p className="text-slate-400 text-lg">Globally distributed pub/sub infrastructure purpose-built for high-frequency financial data delivery with enterprise-grade reliability.</p>
            </div>
