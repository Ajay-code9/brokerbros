...
export const IbPartnerModulePage: React.FC<PageProps> = ({ onOpenAccount }) => {
  ...
  const faqs = [
    ...
    { q: 'Is the IB portal white-labeled?', a: 'Absolutely. The IB portal is fully brandable — custom domain, your logo, color scheme, and marketing assets. Your partners will see only your brand.' },
    { q: 'How does affiliate tracking work?', a: 'Each IB gets unique referral links with UTM parameters. We track clicks, registrations, and deposits with cookie-based attribution and support postback URLs for external campaigns.' },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-slate-400 mb-8 leading-relaxed font-light">
                Scale your brokerage with multi-tier IB systems, real-time rebate calculations, and comprehensive partner portals. Empower your affiliates to grow your business.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-800/50">
            <div className="text-center">
              <div className="text-3xl font-black text-white font-mono mb-1">10k+</div>
      ...
      <section className="py-24 border-b border-slate-800/50 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Partner Network Hub</h2>
            <p className="text-slate-400 text-lg">Everything you need to build, manage, and scale a global network of introducing brokers and affiliates.</p>
          </div>
      ...
      <section className="py-24 border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">IB Infrastructure</h2>
              <p className="text-slate-400 text-lg">Purpose-built tools for managing complex partner relationships, automated payouts, and marketing attribution at scale.</p>
            </div>
