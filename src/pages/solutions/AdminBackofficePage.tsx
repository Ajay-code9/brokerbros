...
export const AdminBackofficePage: React.FC<PageProps> = ({ onOpenAccount }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-300 min-h-screen transition-colors duration-300 selection:bg-emerald-500/30 font-sans">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                ...
                <button className="px-8 py-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-bold rounded-lg border border-slate-200 dark:border-slate-800 transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-xs">
              ...
              <div className="flex flex-wrap items-center gap-6 text-[11px] font-mono text-slate-500">
                <div className="flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-emerald-600 dark:text-emerald-500" /> SOC2 Compliant</div>
                <div className="flex items-center gap-1.5"><Server className="w-4 h-4 text-emerald-600 dark:text-emerald-500" /> 99.99% Uptime SLA</div>
                <div className="flex items-center gap-1.5"><Check className="w-4 h-4 text-emerald-600 dark:text-emerald-500" /> GDPR Ready</div>
              </div>
            </div>
      ...
      <ProductVideoSection
        title="Admin Backoffice & Risk Desk Walkthrough"
        subtitle="Watch how dealing desk managers, compliance officers, and finance teams operate from one unified institutional workspace."
        videoSrc="/test3.mp4"
        posterSrc="/fix-bridge-showcase.webp"
      />

      {/* PRODUCT GALLERY SHOWCASE (2 SECTIONS BELOW HERO) */}
      <ProductGallerySection
        title="Admin Backoffice & Risk Workstation Gallery"
        subtitle="Explore screenshots of real-time A/B book execution routing, financial ledgers, MT4/MT5 manager hooks, and audit logs."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-200 dark:divide-slate-800/50">
            <div className="text-center">
              <div className="text-3xl font-black text-slate-900 dark:text-white font-mono mb-1">360°</div>
      ...
      <section className="py-24 border-b border-slate-200 dark:border-slate-800/50 relative bg-slate-50/80 dark:bg-transparent">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Admin Command Center</h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg">A unified operations hub for risk managers, compliance officers, finance teams, and support staff to run your brokerage.</p>
          </div>
      ...
      <section className="py-24 border-b border-slate-200 dark:border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-4">Backoffice Architecture</h2>
              <p className="text-slate-600 dark:text-slate-400 text-lg">Enterprise-grade admin tools with real-time risk monitoring, compliance automation, and granular access control for your entire staff.</p>
            </div>
