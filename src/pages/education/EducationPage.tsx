...
export const EducationPage: React.FC<PageProps> = ({ onOpenAccount }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-300 min-h-screen font-sans transition-colors duration-300">
      <section className="relative bg-white dark:bg-[#0a0a0a] text-slate-900 dark:text-white py-20 lg:py-24 border-b border-slate-200/80 dark:border-slate-800 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 dark:bg-emerald-950/50 text-emerald-800 dark:text-emerald-400 text-xs font-semibold rounded-md border border-emerald-200 dark:border-emerald-800/50 font-mono">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div
              ...
              className="bg-white dark:bg-[#0a0a0a] p-8 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-emerald-500 dark:hover:border-emerald-500 hover:shadow-lg transition-all cursor-pointer space-y-4 group"
            >
              <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-400 rounded-lg flex items-center justify-center font-bold border border-emerald-200 dark:border-emerald-800/40">
                <GraduationCap className="w-6 h-6 text-emerald-700 dark:text-emerald-400" />
              </div>
              <h3 className="text-2xl font-bold font-serif-heading text-slate-900 dark:text-white group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">
              ...
              <div className="pt-2 text-xs font-bold text-emerald-700 dark:text-emerald-400 flex items-center gap-1">
